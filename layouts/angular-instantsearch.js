      ...
      <ul className="grid grid-flow-row gap-2">
        <li>
          ...
          >
            <ul className="grid grid-flow-row gap-2">
              <li>
                <Link href="/ui-libraries/angular-instantsearch/api-reference/basics/instantsearch">
                  <a
                    className={[
                      "block py-1 cursor-pointer",
              ...
              <li>
                <Link href="/ui-libraries/angular-instantsearch/api-reference/basics/index-widget">
                  <a
                    className={[
                      "block py-1 cursor-pointer",
              ...
              <li>
                <Link href="/ui-libraries/angular-instantsearch/api-reference/basics/searchbox">
                  <a
                    className={[
                      "block py-1 cursor-pointer",
        ...
        <li>
          ...
          >
            <ul className="grid grid-flow-row gap-2">
              <li>
                <Link href="/ui-libraries/angular-instantsearch/api-reference/results/hits">
                  <a
                    className={[
                      "block py-1 cursor-pointer",
